...
\NormalTok{pairwise\_distances }\OtherTok{\textless{}{-}}\NormalTok{ distance\_matrix[}\FunctionTok{c}\NormalTok{(}\StringTok{"HSC"}\NormalTok{, }\StringTok{"CD8"}\NormalTok{, }\StringTok{"MTAC"}\NormalTok{), }\FunctionTok{c}\NormalTok{(}\StringTok{"HSC"}\NormalTok{, }\StringTok{"CD8"}\NormalTok{, }\StringTok{"MTAC"}\NormalTok{)]}
\NormalTok{pairwise\_distances}
\end{Highlighting}
\end{Shaded}
...
dissimilar cell types. HSC and CD8 show a moderate distance (46.06),
indicating similarity within the blood lineage. MTAC (skin lineage) is
much further from both HSC (78.55) and CD8 (81.78),which reflects clear
separation between blood and skin methylation profiles.
